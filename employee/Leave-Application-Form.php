<?php
 include("Logic-Layer/process-leave-application.php");
...
?>
    ...
    <input type="file" id="certificate" name="certificate"><br><br>
        ...
        <div class="form-group">
                <label for="employmentNumber">Days</label>
                <input type="number" name="days" class="form-control" id="employmentNumber" placeholder="Enter number of days">
            </div>
