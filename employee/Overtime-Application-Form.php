<?php
 include("Logic-Layer/process-overtime-application.php");
?>
<!DOCTYPE html>
<html lang="en">
...
?>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <h1 class="mt-5">Overtime Application Form</h1>
        <form method="post" >
    <div class="form-group">
        <label for="reason">Reason for Overtime</label>
        <textarea style="height:200px" name="reason" class="form-control" id="reason" rows="3" placeholder="Enter your reason"></textarea>
    </div>
    <div class="form-group">
