...
include("Logic-Layer/delete-account.php");
...
?>
    ...
    <form action="" method="POST">
        ...
        <div class="mb-3">
            <label for="delete_employee_id">Are You sure you Want to delete this user</label></br>
            </br>
            <input type="hidden" name="id" value="<?php echo trim($_GET['id']);?>"/>
            <input type="submit" value="Delete Employee" class="btn btn-danger" name ="submit">
        </div>
