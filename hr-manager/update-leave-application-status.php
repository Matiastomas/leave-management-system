...
<?php
 ...
 include("Logic-Layer/process-leave-application-status.php");
      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <form method ="post">
                ...
                <textarea name="comment"  style="height:300px;" rows="8" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea></br></br>
                <input type="submit" value="Update Apllication Status" class="btn btn-dark" name ="submit">
