...
?>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="row">
      <div class="col-md-12 fw-bold fs-3">Employee Accounts</div>
    </div>
          <div class="card-body">
...
<td>
    <a href="update-employees.php?id=<?php echo $row['employee_id']; ?>" class="btn btn-primary">Update</a><br><br>
</td>
<td>
    <a href="delete-employees.php?id=<?php echo $row['employee_id']; ?>" class="btn btn-danger">Delete User</a><br><br>
</td>
