...
?>
<?php
 include("Logic-Layer/add-employee.php");
?>
      ...
      <div class="main-panel">
        ...
        <form  method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" name="employeePassword" class="form-control" id="employeePassword" placeholder="Enter password">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="employmentNumber" class="form-control" id="employmentNumber" placeholder="Enter employment number">
            </div>
          
            <div class="form-group">
                <label for="contact">Contact Information</label>
                <input type="text" name="contact" class="form-control" id="contact" placeholder="Enter contact information">
            </div>
            <input type="submit" class="btn btn-primary" value ="Add Employee" name="submit">
        </form>
          </div>
        </div>
