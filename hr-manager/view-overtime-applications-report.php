...
$query = "SELECT * FROM overtime_application";
...
?>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="row">
      <div class="col-md-12 fw-bold fs-3">Overtime Application Report</div>
    </div>
          <div class="card-body">
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
            <td><?php echo $row['overtime_id']; ?></td>
...
<td>
    <a href="update-overtime-application-status.php?id=<?php echo $row['overtime_id']; ?>" class="btn btn-primary">Update Application Status</a><br><br>
</td>
