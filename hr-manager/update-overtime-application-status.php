...
include("Logic-Layer/process-overnight-application-status.php");
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/Leave-management-system/hr-manager/view-overtime-applications-report.php" aria-expanded="false" aria-controls="ui-basic">Overtime Application Report</a>
        ...
        <div class="content-wrapper">
            ...
            <form method ="post">
                ...
                <option  id="">Pending</option>
                    <option  id="">Approved</option>
                    <option  id="">Rejected</option>
                </select> </br></br>
                <label>Provide Comments</label> </br>
                <textarea name="comment"  style="height:300px;" rows="4" class="form-control" id="exampleFormControlTextarea1"></textarea></br></br>
                <input type="submit" value="Update Application Status" class="btn btn-dark" name ="submit">
