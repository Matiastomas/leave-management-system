<?php
require_once("Logic-Layer/database-connection.php"); 
...
if (isset($_POST['submit'])) {
    ...
    // Prepare the SQL UPDATE statement with parameterized query
...
if (mysqli_query($conn, $sql)) {
  ...
  header("location:manage-employee-accounts.php");
        ...
        // Execute the prepared statement
            ...
            echo "<p style='color: green'>Account details updated successfully.</p>";
        } else {
...
if (isset($_GET['id'])) {
  ...
  // Select employee details from the database
  $sql = "SELECT * FROM employee WHERE employee_id = $id"; // Use $id, not $employee_id
  ...
  if ($result) {
      ...
      if ($row) {
          ...
          // Your update form can be displayed here
      } else {
...
?>
    ...
    <form method="post" action="">
        <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['employee_id']); ?>" />
        <label for="username">Username:</label>
        <input type="text" name="username" id="username" required value="<?php echo htmlspecialchars($row['username']); ?>"><br><br>

        <label for="employee_password">Password:</label>
        <input type="password" name="employee_password" id="employee_password" required value="<?php echo htmlspecialchars($row['employee_password']); ?>"><br><br>

        <label for="department">Department:</label>
        <input type="text" name="department" id="department" required value="<?php echo htmlspecialchars($row['department']); ?>"><br><br>

        <label for="employmentNumber">Employment Number:</label>
        <input type="text" name="employmentNumber" id="employmentNumber" required value="<?php echo htmlspecialchars($row['employmentNumber']); ?>"><br><br>

        <label for="contact">Contact Information:</label>
        <input type="text" name="contact" id="contact" required value="<?php echo htmlspecialchars($row['contact']); ?>"><br><br>
